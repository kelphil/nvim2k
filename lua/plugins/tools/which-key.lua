...
local mappings = {
	...
	f = {
	    ...
	    B = { "<cmd>Telescope bookmarks<cr>", "Browser Link bookmarks" },
		...
		g = { "<cmd>Telescope live_grep grep_open_files=true<cr>", "Find in Open Files" },
		...
		s = { '<cmd>lua require("telescope").extensions.menufacture.live_grep()<cr>', "Find Text" },
	...
	m = {
		...
		a = { '<cmd>lua require("harpoon-core.mark").add_file()<cr>', "Harpoon Add" },
		r = { '<cmd>lua require("harpoon-core.mark").rm_file()<cr>', "Harpoon Remove" },
	...
	n = {
		...
		o = { "<cmd>ObsidianOpen<cr>", "Open in UI" },
