...
local n_mappings = {
    ...
    { '<leader>gg', '<cmd>LazygitToggle<cr>', desc = 'Lazygit' },
    ...
    { '<leader>nd', '<cmd>vsplit || ObsidianToday<cr>', desc = "Daily Note" },
    { '<leader>nl', '<cmd>ObsidianFollowLink<cr>', desc = "Follow Link" },
    { '<leader>nn', '<cmd>Obsidian<cr>', desc = "All Notes" },
    ...
    { '<leader>nta', '<cmd>MarkdownTODOADD<cr>', desc = "Mark as TODO" },
    { '<leader>ntd', '<cmd>MarkdownTODODONE<cr>', desc = "Mark as DONE" },
    { '<leader>ntt', '<cmd>TodoTelescope<cr>', desc = "All TODOs" },
...
local no_leader_mappings = {
    ...
    { '<C-g>', '<cmd>LazygitToggle<cr>', desc = 'Lazygit' },
